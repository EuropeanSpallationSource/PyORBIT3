...
from orbit.core.trackerrk4 import RungeKuttaTracker, PyExternalEffects
...
(x, xp, y, yp, z, dE) = (0.05, 0.0, 0.05, 0.0, 0.0, 0.001)
bunch_ini.addParticle(x, xp, y, yp, z, dE)
...
paramsDict = {"old_pos": -1.0, "count": 0, "pos_step": 0.1, "path_length": 0.0}
...
st = ""
(x, xp, y, yp, z, dE) = (
    bunch_tmp.x(0) * 1000.0,
    bunch_tmp.xp(0) * 1000.0,
    bunch_tmp.y(0) * 1000.0,
    bunch_tmp.yp(0) * 1000.0,
...
(x, xp, y, yp, z, dE) = (
    ...
    bunch_tmp.y(1) * 1000.0,
    bunch_tmp.yp(1) * 1000.0,
