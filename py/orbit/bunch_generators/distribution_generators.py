...
class KVDist2D:
    ...
    def __init__(self, twissX=TwissContainer(0.0, 1.0, 1.0), twissY=TwissContainer(0.0, 1.0, 1.0)):
        """Constructor"""
    ...
    def getCoordinates(self):
        ...
        # momentum
        p0 = math.sqrt(math.fabs(1.0 - rho**2))
        phi = 2 * math.pi * (random.random() - 0.5)
...
class WaterBagDist3D:
    ...
    def getCoordinates(self):
        ...
        g = math.pow(random.random(), 1.0 / 6.0)
...
class GaussDist1D:
    ...
    def __init__(self, twiss=TwissContainer(0.0, 1.0, 1.0), cut_off=-1.0):
        """Constructor"""
        self.twiss = twiss
    ...
    def getCoordinates(self):
        ...
        x_norm = random.gauss(0.0, 1.0)
        xp_norm = random.gauss(0.0, 1.0)
        if self.cut_off > 0.0:
...
class TwissAnalysis:
    ...
    def __init__(self, nD):
        ...
        for i in range(self.nD):
            self.x2_avg_v.append(0.0)
            self.xp2_avg_v.append(0.0)
            self.x_xp_avg_v.append(0.0)
            self.x_avg_v.append(0.0)
            self.xp_avg_v.append(0.0)
            self.xp_max_v.append(-1.0e38)
            self.x_max_v.append(-1.0e38)
            self.xp_min_v.append(1.0e38)
            self.x_min_v.append(1.0e38)
        self.Np = 0
